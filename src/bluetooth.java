...
public class bluetooth extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Select brand of Bluetooth");
        getContentPane().add(jLabel1);
        jLabel1.setBounds(134, 49, 177, 17);

        jButton1.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jButton1.setText("SONY");
        ...
        jButton1.setBounds(164, 97, 73, 25);

        jButton2.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jButton2.setText("JBL");
        ...
        jButton2.setBounds(164, 140, 57, 25);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(bluetooth.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
